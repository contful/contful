...
public class StringUtil extends org.apache.commons.lang3.StringUtils {
    ...
    /**
     * 格式化文本, {} 表示占位符
     * 例如：format("aaa {} ccc", "bbb")   转   aaa bbb ccc
     *
     ...
     * format("{a} and {b}", map)    转 aValue and bValue
     *
    ...
    public static ByteBuffer byteBuffer(String str, String charset) {
        return ByteBuffer.wrap(StringUtil.bytes(str, charset));
    }
